      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <b>Método: </b> POST <br />
            <b>Headers: </b> Portador de autorización (token registrado) e Content-Type (application/json) <br />
            <b>Body: </b> {"{"} <br></br>
             "number": "584241278885" <br></br>
             "body": "Message" <br></br> 
        ...
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            ...
            <ul>
              ...
              <li>
                <b>sendSignature:</b> Firmar mensaje verdadero/falso
              </li>
            </ul>
          </Typography>
        </Grid>
